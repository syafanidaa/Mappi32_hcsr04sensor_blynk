#define BLYNK_TEMPLATE_ID "TMPLzTWwsdWE" //ID Template
#define BLYNK_DEVICE_NAME "HCSR04" // Nama Device
#define BLYNK_AUTH_TOKEN "xf4eAcy84eUpZQCgV9QhbkrCDeSbUAZ1" // Token dari Blynk
#include <WiFi.h>
