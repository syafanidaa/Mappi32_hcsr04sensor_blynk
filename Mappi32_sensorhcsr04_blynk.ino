#define BLYNK_TEMPLATE_ID "XXXXXXXXXX" //ID Template
#define BLYNK_DEVICE_NAME "XXXXXXX" // Nama Device
#define BLYNK_AUTH_TOKEN "XXXXXXXXXXXXXXXXXXXX" // Token dari Blynk
#include <WiFi.h>
...
char ssid[] = "XXXXXXX";   // Nama Hotspot / WiFi
